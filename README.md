...
[Kibana](http://158.160.72.186/) 
[Zabbix](http://158.160.31.191/zabbix) 
...
Заходим на сервера `ssh -A -J vb@158.160.74.108 vb@ip-web` web и проверяем статус служб zabbix-agent
web1
